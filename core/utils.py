...
"""
Khai báo một số hàm hỗ trợ việc detection bằng yolo4:

    # Load file để detect object
    - load_freeze_layer
    - load_weight
    - read_class_names
    - load_config
    ...
    # Hỗ trợ hiển thị bounding box các vật thể
    - format_boxes
    - draw_bbox

    # Các hàm xử lý tính toán để chọn bounding box phù hợp
    - bbox_iou
    - bbox_giou
    - bbox_ciou
    - nms

    # Đóng băng, không đóng băng lớp khi training
    - freeze_all
    - unfreeze_all
"""
